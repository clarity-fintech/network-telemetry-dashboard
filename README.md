...
- `mis/kernel/NetworkTelemetryDashboardKernel.mis`
...
```bash
bin/misc mis/kernel/NetworkTelemetryDashboardKernel.mis --check --compact-letters
find mis -name '*.mis' -print0 | xargs -0 -n1 bin/misc --check --compact-letters
```

## Org

[clarity-fintech/network-telemetry-dashboard](https://github.com/clarity-fintech/network-telemetry-dashboard)
